...
@section('title', 'Tambah Lisensi (PG + Wawancara)')
...
@push('styles')
    ...
    <style>
        :root {
            ...
            --bg-light: #f1f5f9;
            --input-border: #cbd5e1;
            /* Warna Tema: Biru Laut untuk PG + Interview */
            --accent-color: #0ea5e9;
            --accent-hover: #0284c7;
            --accent-light: #e0f2fe;
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">Tambah Lisensi (PG + Wawancara)</h1>
                        <p class="text-muted small mb-0">Formulir administrasi data lisensi metode gabungan.</p>
                    </div>
                    {{-- ROUTE BACK SPESIFIK --}}
                ...
                <div class="form-card">
                    ...
                    <form action="{{ route('admin.lisensi_pg_interview.store') }}" method="POST">
                        @csrf

                        <div class="row g-3">

                            {{-- 1. Aturan Perpanjangan (HARDCODED) --}}
                            <div class="col-12">
                                <div class="metode-wrapper">
                                    <div class="d-flex gap-3 align-items-center">
                                        <i class="bi bi-file-earmark-text fs-4" style="color: var(--accent-color);"></i>
                        ...
                        <div class="mt-4 pt-2">
                            <button type="submit" class="btn-submit">
                                <i class="bi bi-save2 me-1"></i> Simpan Lisensi (PG + Interview)
                            </button>
                        </div>
