...
<style>
    :root {
        --primary-blue: #2563eb; /* Royal Blue yang Jernih */
    ...
    .btn-blue {
        ...
        box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.2); /* Shadow Biru Halus */
    ...
    .custom-table thead th {
        background-color: #f1f5f9; /* Header Abu Muda */
        color: #475569;
        font-size: 0.75rem;
        font-weight: 700;
    ...
    /* Hover Row jadi agak biru dikit */
...
<div class="container py-5">
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Riwayat Pelatihan</h1>
            <p class="page-subtitle">Daftar pengembangan kompetensi dan sertifikasi.</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('perawat.drh') }}" class="btn-white">
                <i class="bi bi-arrow-left"></i> Kembali
            </a>
            <a href="{{ route('perawat.pelatihan.create') }}" class="btn-blue">
    ...
    <div class="table-card">
        <div class="table-responsive">
            <table class="custom-table">
                ...
                <tbody>
                    @forelse($pelatihan as $row)
                        <tr>
                            {{-- Nama & Tempat --}}
                            <td>
                                <span class="data-title">{{ $row->nama_pelatihan }}</span>
                                <span class="data-sub">
                                    <i class="bi bi-geo-alt"></i> {{ $row->tempat ?? 'Online' }}
                                </span>
                            </td>

                            {{-- Penyelenggara --}}
                            <td>
                                <span class="fw-medium text-dark">{{ $row->penyelenggara }}</span>
                            </td>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route('perawat.pelatihan.edit', $row->id) }}" class="action-btn" title="Edit">
