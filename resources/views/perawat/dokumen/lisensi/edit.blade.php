    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="form-card">
                ...
                <form action="{{ route('perawat.lisensi.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-5">
                        <button type="submit" class="btn-submit-edit">
                            <i class="bi bi-check-lg"></i> Update Lisensi
                        </button>
                    </div>
                </form>
            </div>
