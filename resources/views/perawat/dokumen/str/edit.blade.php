...
@section('title', 'Edit STR – DIKSERA')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="page-header">
                <div><h1 class="page-title">Edit STR</h1></div>
            ...
            <div class="form-card">
                ...
                <form action="{{ route('perawat.str.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-5">
                        <button type="submit" class="btn-submit-edit">
                            <i class="bi bi-check-lg"></i> Update STR
                        </button>
                    </div>
                </form>
            </div>
