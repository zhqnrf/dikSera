...
<div class="container py-5">
    <div class="page-header">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('perawat.str.create') }}" class="btn-blue"><i class="bi bi-plus-lg"></i> Tambah STR</a>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="custom-table">
                <thead>
                    <tr>
                        <th width="5%">No</th>
                        <th width="20%">Nama STR</th> {{-- Kolom Baru --}}
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route('perawat.str.edit', $item->id) }}" class="action-btn" title="Edit"><i class="bi bi-pencil-fill"></i></a>
