                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="nama_lengkap" class="form-control"
                                    value="{{ old('nama_lengkap', $profile->nama_lengkap ?? $user->name) }}" placeholder="Contoh: Ns. Siti Aminah, S.Kep">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Aliran Kepercayaan <small class="text-muted">(Opsional)</small></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="hobby" class="form-control"
                                    value="{{ old('hobby', $profile->hobby ?? '') }}" placeholder="Contoh: Membaca Jurnal, Jogging, Renang">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kota" class="form-control"
                                    value="{{ old('kota', $profile->kota ?? '') }}" placeholder="Contoh: Jakarta Selatan">
                            </div>
                            <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="jabatan" class="form-control"
                                    value="{{ old('jabatan', $profile->jabatan ?? '') }}" placeholder="Contoh: Perawat Ahli Muda">
                            </div>
                            <div class="col-6 col-md-3">
                        ...
                        <div class="row align-items-center bg-light border rounded-3 p-3 mx-1">
                            <div class="col-auto">
                                @if($profile && $profile->foto_3x4)
                                    <img src="{{ asset('storage/'.$profile->foto_3x4) }}" class="avatar-preview shadow-sm">
                                @else
...
<style>
    ...
    .section-header i {
        color: #3b82f6; /* Warna Primary Bootstrap */
    }
