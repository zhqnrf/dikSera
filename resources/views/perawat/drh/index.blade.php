        ...
        <div class="d-flex flex-column flex-md-row align-items-center gap-4">
            ...
            <div class="flex-shrink-0">
                <div class="hero-icon-circle" style="width:100px;height:100px;">
                    @if(!empty($profile->foto_3x4))
                        <img src="{{ asset('storage/' . $profile->foto_3x4) }}" class="hero-icon-img" style="object-fit: cover" alt="Foto Profil">
                    @else
            ...
            <div class="flex-grow-1 text-center text-md-start">
                ...
                <div class="text-muted mb-2">
                    ...
                    @if($profile->nip) | NIP. {{ $profile->nip }} @endif
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-sm small align-middle mb-0">
                        ...
                        <tr>
                            ...
                            <td class="fw-bold">: {{ $profile->tempat_lahir ?? '—' }}, {{ $profile->tanggal_lahir ? date('d-m-Y', strtotime($profile->tanggal_lahir)) : '—' }}</td>
                        </tr>
                        <tr>
                            <td class="text-muted">Jenis Kelamin</td>
                            <td class="fw-bold">: {{ $profile->jenis_kelamin == 'L' ? 'Laki-laki' : ($profile->jenis_kelamin == 'P' ? 'Perempuan' : '—') }}</td>
                        </tr>
                        <tr>
